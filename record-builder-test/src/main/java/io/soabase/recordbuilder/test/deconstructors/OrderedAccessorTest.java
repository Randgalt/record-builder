...
@Deconstructor
public class OrderedAccessorTest {
    private String something;
    private int another;

    private OrderedAccessorTest(String something, int another) {
        this.something = something;
        this.another = another;
    }

    @DeconstructorAccessor(order = 1)
    public String getZomething() {
        return something;
    }
