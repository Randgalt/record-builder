...
public final class GsonTypes {
     ...
     */
    public static ParameterizedType newParameterizedTypeWithOwner(Type ownerType, Class<?> rawType,
            Type... typeArguments) {
     ...
     * {@code CharSequence.class}, this returns {@code ? extends CharSequence}. If {@code bound} is
     * {@code Object.class}, this returns {@code ?}, which is shorthand for {@code ?
     * extends Object}.
     */
    ...
    private static Type resolve(Type context, Class<?> contextRawType, Type toResolve,
        ...
        while (true) {
            if (toResolve instanceof TypeVariable) {
                ...
                toResolve = ownerChanged || argsChanged
                        ? newParameterizedTypeWithOwner(newOwnerType, (Class<?>) original.getRawType(), args)
                        : original;
                break;
    ...
    /**
     * Whether an {@linkplain ParameterizedType#getOwnerType() owner type} must be specified when constructing a
     * {@link ParameterizedType} for {@code rawType}.
     *
     * <p>
     * Note that this method might not require an owner type for all cases where Java reflection would create
     * parameterized types with owner type.
     */
     ...
     * target Java version supports - at most one bound, see also https://bugs.openjdk.java.net/browse/JDK-8250660. If a
     * lower bound is set, the upper bound must be Object.class.
     */
