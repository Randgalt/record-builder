...
public class TestTypes {
    ...
    public static class BagOfPrimitives {
        ...
        @Deconstructor
        public void deconstructor(LongConsumer longValue, IntConsumer intValue, Consumer<Boolean> booleanValue,
                Consumer<String> stringValue) {
            longValue.accept(this.longValue);
            intValue.accept(this.intValue);
            booleanValue.accept(this.booleanValue);
            stringValue.accept(this.stringValue);
        }
        ...
        public boolean equals(Object o) {
            ...
            return longValue == that.longValue && getIntValue() == that.getIntValue()
                    && booleanValue == that.booleanValue && Objects.equals(stringValue, that.stringValue);
        }

        @Override
        public String toString() {
            return String.format("(longValue=%d,intValue=%d,booleanValue=%b,stringValue=%s)", longValue, intValue,
    ...
    public static class ClassWithObjects {
        ...
        @Deconstructor
        public void deconstructor(Consumer<BagOfPrimitives> bag) {
            bag.accept(this.bag);
        }
    }
