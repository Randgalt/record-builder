...
| `@RecordBuilder.Options(concreteSettersForOptionalNullabilityAnnotation = "com.foo.Nullable")` | Add the specified nullability annotation to the non-optional setter methods for optional record components. The default is not to add an annotation.             |
